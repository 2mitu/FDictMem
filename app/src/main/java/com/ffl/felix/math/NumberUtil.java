...
public class NumberUtil {
     ...
     * @param bytes		byte数组
     * @param offset 	开始位置
     * @param bigEndian	字节顺序，高字节在前
     * @return int	整数
     */
    public static int byte4ToInt(byte[] bytes, int offset, boolean bigEndian) {
        ...
        // LITTLE_ENDIAN: least significant byte in the smallest address
